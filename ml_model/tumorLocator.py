...
source_path = Path(r'C:\Abhijay\PennApps\RealBrainTumorData')
...
tumour_images=[]
for name in glob.glob('C:/Abhijay/PennApps/RealBrainTumorData/yes/*.jpg'): 
...
img_path = "C:/Abhijay/PennApps/RealBrainTumorData/yes/Y1.jpg"
